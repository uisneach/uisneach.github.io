...
function listCategoriesHelper(categories, options) {
    ...
    const url_redirect_list = ['categories/Library/'];
    ...
    const hierarchicalList = (level, parent) => {
        ...
        prepareQuery(parent).forEach((cat) => {
            ...
            // Added a dictionary to allow for redirects from the category tags away from the default pages, since in my Hexo site I have a page called Library and a tag called Library, and I don't want an extra category page for library posts. - GoF
            var pathVar = cat.path;
            if (url_redirect_list.indexOf(cat.path) > -1)
                pathVar = '/library/index.html';
