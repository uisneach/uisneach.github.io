...
function renderFootnotes(text) {
  ...
  footnotes.forEach(function(footNote) {
    html += '<li id="fn:' + footNote.index + '" style="margin-bottom: 15px;">'; // I added margin-bottom here. - GoF
    html += '<span style="display: inline; vertical-align: top; padding-right: 10px;">'; // I changed 'inline-block' to 'inline'. - GoF
    html += footNote.index;
    html += '.</span>';
    html += '<span style="display: inline; vertical-align: top;">'; // Here too
