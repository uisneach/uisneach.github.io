...
{% image "/American-Genetics/Boones-First-View-of-Kentucky-William-Renney.jpg" %}
...
{% image "https://pbs.twimg.com/media/FRmauz2WYAAlP7T.jpg", "Principal components (PCs) are computed using kernel PCA, in which the kernel matrix is defined by total IBD between pairs of states, normalized to remove the effect of variation in within-state IBD. US states that share high levels of IBD on average are placed closer to each other in the projection onto the first two principal components. The area of each circle is scaled by number of self-reported birth locations in the state (Supplementary Fig. 1). US states are coloured by geographic region (Northeast, South, Midwest and West).", "PCA Chart" %}
...
{% image "https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fncomms14238/MediaObjects/41467_2017_Article_BFncomms14238_Fig5_HTML.jpg?as=webp", "Fig. 5: In a, each circle gives the mean latitude (in degrees) of all pedigree birth location annotations within a given generation linked to genotypes assigned to each of the five clusters; end points of vertical bars represent 10th and 90th empirical percentiles. These statistics are compiled from pedigree annotations with US birth locations only. Note that ‘0 generations ago’ refers to genotyped individuals. For contrast, b shows the same statistics, but for longitude instead of latitude. Each degree of longitude or latitude is roughly equivalent to 100 km. Examples of US cities by latitude and longitude include Boston, MA (42.4, −71.1), New Orleans, LA (30.0, −90.1) and Sacramento, CA (38.6, −121.5).", "Five largest clusters predict North-South US geography across multiple generations" %}
...
{% image "https://pbs.twimg.com/media/FRma-XfXMAAXeFQ.jpg", "", "Region Map" %}
{% image "https://pbs.twimg.com/media/FRma_f9XMAAD0DH.png", "Geographic regions corresponding to ancestral populations in global ancestry reference panel. See Supplementary Table 2 for composition the panel. Admixture proportions for these regions are collapsed into a single admixture proportion representing West Africa. Map and figure designed by AncestryDNA.", "Region Map Zoomed In" %}
...
{% image "https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fncomms14238/MediaObjects/41467_2017_Article_BFncomms14238_Fig4_HTML.jpg?as=webp", "Fig. 4: Map locations are plotted if OR>10 within the indicated range of pedigree generations (date ranges give the 5th and 95th percentiles of birth year annotations). Points are scaled by number of pedigree annotations, separately for each of the six maps. Note that not all current political borders are shown.", "Genealogical data traces origins of Cajuns/Acadians in Atlantic Canada (blue) and migration of French Canadians (magenta) to the US." %}
...
{% image "https://pbs.twimg.com/media/FRmesgDX0AYQpDL.jpg", "Supp. Fig. 17: Distribution of birth locations in Europe, by generation.", "Distribution of birth locations in Europe, by generation." %}
...
{% image "https://pbs.twimg.com/media/FRmfNv5XoAAseh6.jpg", "Supp. Fig. 18a", "Distribution of ancestral birth locations worldwide, in North America, and in Europe, for each cluster detected in an IBD sub-network." %}

{% image "https://pbs.twimg.com/media/FRmfPdFXwAMAYz9.jpg", "Supp. Fig. 19a", "Distribution of ancestral birth locations worldwide, in North America, and in Europe, for each cluster detected in an IBD sub-network." %}
...
{% image "https://pbs.twimg.com/media/FRmfiBcWUAAgmjb.jpg", "", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmfpS2WUAEsOk3.jpg", "Supp. Fig. 18b", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmfxexXsAIUdam.jpg", "Supp. Fig. 19i", "Tweet Image" %}

### The Lower South

From the coastal Carolinas, these settlers swept along Florida, Alabama, and Mississippi into Eastern Texas. In 1814, the Creek Indians were expelled or forced to give up land, the opening-up of this territory and “Alabama Fever” gripped many South Carolinans which caused them to move in. A similar migration occurred in 1820-30s Georgia and Florida when Indians were expelled and Whites took their place. Notice again the separation between Anglo Louisiana and French Louisiana.

{% image "https://pbs.twimg.com/media/FRmgIOqWYAERqMf.jpg", "Supp. Fig. 19j", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmg_DoXoAE0KQS.jpg", "Supp. Fig. 18h", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmhINdXoAEol2z.jpg", "Supp. Fig. 27a", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmhJvQXwAA2zeG.jpg", "Supp. Fig. 27b", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmhLDmWYAYHfK_.jpg", "Supp. Fig. 27c", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmgj1gXIAESuWs.jpg", "Supp. Fig. 20a", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmg8e9XIAoN_IR.jpg", "Supp. Fig. 24: Genealogical data by generation trace US migration and European origins of Utah cluster. The size of each point is scaled by number of pedigree birth location annotations, separately for each of the 6 maps. Date ranges are the 5th and 95th percentiles of the birth year annotations", "Genealogical data by generation trace US migration and European origins of Utah cluster" %}
...
{% image "https://pbs.twimg.com/media/FRmh6E9XwAEgq-p.jpg", "Supp. Fig. 26f South Ireland / Munster", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmh7Q9X0AAYh0Z.jpg", "Supp. Fig. 26h West Ireland / Connaught", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmiJjkWQAYz3p5.jpg", "Supp. Fig. 26g North Ireland / Ulster", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmiPxPWYAMLp86.jpg", "Supp. Fig. 20d", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmiQ0CXIAI9Cy7.jpg", "Supp. Fig. 26e", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmiTOLXIAEqtRL.jpg", "Supp. Fig. 19d", "Tweet Image" %}

### Nuevos Mexicanos

Descended from the European Spanish settlers of New Mexico territory, this enclave makes up the primary ancestry of New Mexican ethnos. These are not Mexicans, but have been here since the Spanish settlement along the Camino Real de Tierra Adentro trail since 1598, which you can actually trace based on the settlement pattern shown below.

{% image "https://pbs.twimg.com/media/FRmigGDXoAEsK3R.jpg", "Supp. Fig. 19n", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmil8PXwAE_w_Z.jpg", "Camino Real de Tierra Adentro", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmjAjRX0AMLOUm.jpg", "Supp. Fig. 19g", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmjMhoWQAUxSXD.jpg", "Supp. Fig. 19e", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmjVn6XEAI7XQ1.jpg", "Supp. Fig. 20f", "Tweet Image" %}

{% image "https://pbs.twimg.com/media/FRmjfgyXsAIzoLn.jpg", "Supp. Fig. 20g", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmjjovWUAEYW0E.jpg", "Supp. Fig. 20h", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmjoQVXsAI5aRE.jpg", "Supp. Fig. 26i", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRnFJhOXoAc1R00.jpg", "Supp. Fig. 26j", "Tweet Image" %}
...
{% image "American-Genetics/SFig-9.png", "Supp. Fig. 9: Admixture proportions in top-level IBD network clusters. Filled circles correspond to mean admixture proportions, and error bars give [0.05,0.95] credible intervals.", "" %}

{% image "American-Genetics/SFig-11.jpg", "Supp. Fig. 10: Admixture proportions in IBD sub-network clusters. Filled circles correspond to mean admixture proportions, and error bars give [0.05,0.95] credible intervals.", "" %}

{% image "https://pbs.twimg.com/media/FRmlBEXXwAASpCo.jpg", "Supp. Fig. 11: Admixture proportions in stable subsets identified from spectral analysis. Filled circles correspond to mean admixture proportions, and error bars give [0.05,0.95] credible intervals.", "Tweet Image" %}
...
{% image "https://pbs.twimg.com/media/FRmkx8lXwAEo9KR.jpg" %}
